...
_component_func = components.declare_component(
    ...
    #url="http://localhost:5173/", #npm run start with deploy component here 
)
...
def speed_control_component(max_value,min_value,default_value,increment,interval_ms, key=None):
    ...
    component_value = _component_func(max_value=max_value,min_value=min_value,default_value=default_value,increment=increment,interval_ms=interval_ms,key=key, default=0)
